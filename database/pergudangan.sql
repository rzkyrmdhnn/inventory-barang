...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2023 at 03:38 PM
...
CREATE TABLE `tb_brand` (
  `id` int(3) NOT NULL,
  `kdbrand` varchar(20) DEFAULT NULL,
...
CREATE TABLE `tb_gudang` (
  ...
  `kdbrand` varchar(20) NOT NULL,
  `barang` varchar(30) NOT NULL,
  `kdsup` varchar(20) NOT NULL,
  `qty` int(3) NOT NULL,
  `jenis` varchar(15) NOT NULL,
  `hargab` float(9,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
