...
<h1><span class="mb-0 text-gray-800">Rekap pemesanan barang</span></h1></br>
<!-- <center><a href="#" class="btn btn-info" data-target="#ModalAdd" data-toggle="modal" onclick="">Tambah</a> 
<div class="modal-body">
   <form action="../../pergudangan/report/lappesan.php" name="surat_popup" enctype="multipart/form-data" method="POST">
  <form action="" name="surat_popup" enctype="multipart/form-data" method="POST"> 
        ...
        <button class="btn btn-primary" type="submit" name="btn_lanjut" id="btn_lanjut" onclick="autoNumber()">
            Cetak
        </button>
  </form> -->
</div>
...
<?php   
  ...
  // echo '<h3>Total transaksi : <b>Rp.'.$r['SUM(total)'].',00 </b></h3>'; 
?>
</center>
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="text-grey-600">Data Rekap Pemesanan Barang</h6>
    </div>
<div class="card-body">
  ...
  <?php 
    ...
    $no = 0;
    $sql = "SELECT DISTINCT tb_pesan.*,tb_supplier.supplier,tb_supplier.kdsup,tb_gudang.kdbarang,tb_gudang.barang,tb_gudang.kdbrand,tb_brand.kdbrand,tb_brand.brand FROM tb_pesan,tb_supplier,tb_gudang,tb_brand WHERE tb_pesan.kdbarang = tb_gudang.kdbarang AND tb_pesan.kdsup = tb_supplier.kdsup AND tb_gudang.kdbrand = tb_brand.kdbrand AND tb_pesan.kdorder!=''";
    $query = mysqli_query($conn,$sql);
  ...
  ?>
    <tr>
        ...
        <td>
          ...
          <center><img src="../images/icons/delete.png" width="30" height="30" class="hapus" onclick="confirm_modal('../controller/admin/pesan/delete.php?&id=<?php echo  $r['id']; ?>');"></center>
        </td>
    </tr>
