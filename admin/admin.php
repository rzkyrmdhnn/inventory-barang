    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <?php 
                ...
                $dashboard = "http://localhost/pergudangan/admin/dashboard.php?page=dashboard";
                $supplier = "http://localhost/pergudangan/admin/admin.php?page=supplier";
                $pesan = "http://localhost/pergudangan/admin/admin.php?page=pesan";
                $pesanr = "http://localhost/pergudangan/admin/admin.php?page=pesanr";
                $barang = "http://localhost/pergudangan/admin/admin.php?page=barang";
                $barangc = "http://localhost/pergudangan/admin/admin.php?page=barangc";
                $status = "http://localhost/pergudangan/admin/admin.php?page=status";
                $brand = "http://localhost/pergudangan/admin/admin.php?page=brand";
            ...
            <li class="nav-item">
                <?php if($url==$brand) : ?>
                    <a class="nav-link" href="?page=brand">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                            <?php if($url==$barang) : ?>
                                <a class="collapse-item" href="?page=barang">Input Barang</a>
                            <?php else : ?>
                                <a class="collapse-item" href="?page=barang">Input Barang</a>
                            <?php endif; ?>

                            <?php if($url==$barangc) : ?>
                                <a class="collapse-item" href="?page=barangc">Laporan</a>
                            <?php else : ?>
                                <a class="collapse-item" href="?page=barangc">Laporan</a>
                            <?php endif; ?>
                    </div>
            ...
            <!-- Nav Item - Pemesanan Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <?php if($url==$pesan) : ?>
                            <a class="collapse-item" href="?page=pesan">Input Pesan</a>
                        <?php else : ?>
                            <a class="collapse-item" href="?page=pesan">Input Pesan</a>
                        <?php endif; ?>

                        <?php if($url==$pesanr) : ?>
                            <a class="collapse-item" href="?page=pesanr">Rekap</a>
                        <?php else : ?>
                            <a class="collapse-item" href="?page=pesanr">Rekap</a>
                        <?php endif; ?>
                    </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto panel">
